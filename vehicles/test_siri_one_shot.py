...
class SIRIOneShotTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        operator = Operator.objects.create(code='SDVN', region=region, name='Stagecoach Devonshire')
        ...
        with vcr.use_cassette('data/vcr/icarus.yaml'):
            ...
            with freeze_time('2019-06-08'):
                with self.assertNumQueries(6):
                    self.client.get(f'/vehicles.json?service={self.service.id}')
            ...
            with freeze_time('2019-06-08 20:37+01:00'):
                ...
                with self.assertNumQueries(2):
                    res = self.client.get(f'/vehicles.json?service={self.service.id}')
