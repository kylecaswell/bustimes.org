    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='bustimes.Service')),
        ...
        migrations.AddField(
            model_name='vehicle',
            name='operator',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='bustimes.Operator'),
        ),
        migrations.AddField(
            model_name='vehicle',
            name='source',
